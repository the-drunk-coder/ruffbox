...
impl StereoFreeverb {
    pub fn new() -> Self {
        ...
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L1,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R1,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L2,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R2,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L3,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R3,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L4,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R4,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L5,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R5,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L6,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R6,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L7,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R7,
        ));
        comb_l.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_L8,
        ));
        comb_r.push(Comb::with_buffer_size(
            FreeverbDefaultTuning::COMB_TUNING_R8,
        ));

        let mut allpass_l = Vec::new();
        let mut allpass_r = Vec::new();

        allpass_l.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_L1,
        ));
        allpass_r.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_R1,
        ));
        allpass_l.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_L2,
        ));
        allpass_r.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_R2,
        ));
        allpass_l.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_L3,
        ));
        allpass_r.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_R3,
        ));
        allpass_l.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_L4,
        ));
        allpass_r.push(Allpass::with_buffer_size(
            FreeverbDefaultTuning::ALLPASS_TUNING_R4,
        ));
